...
if(!isset($_SESSION['currentUser'])){
 // header("Location: digitalJournal.php");
}
?>
<html lang="en">
  <head>
  ...
  <body>
    ...
    <nav class="navbar is-transparent" style="border-bottom: 2px solid #00d1b2">
      ...
      <div id="digitalJournalnavbar" class="navbar-menu">
        <a class="navbar-item " href="userprofilepage.php">
          Home
        </a>
      </div>
      ...
      <div class="navbar-end">
        <div class="navbar-item">
          <div class="field is-grouped">
            <p class="control">
              <a data-target="#modal" class="button is-primary modal-button"><b>Add Journal Entry</b>
              </a>
            </p>
            <p class="control">
      ...
      <div class="modal-background"></div>
        <div class="modal-card">
          <header class="modal-card-head">
            <p class="modal-card-title">Add Journal Entry</p>
            <button class="delete" id="delete" aria-label="close"></button>
          </header>
          <section class="modal-card-body">
            <form class="form-memo" action="addJournalEntry.php" method="POST">
              <div class="field">
              ...
              <div class="field">
                <label class="label">Journal Summary (*)</label>
    ...
    <div id="updateModal" class="modal">
      <div class="modal-background"></div>
        <div class="modal-card">
          <header class="modal-card-head">
            <p class="modal-card-title">Update Journal Entry</p>
      ...
      <div class="card-content">
        ...
        <div class="container column box">
          <div class="columns">
            ...
            <div class="container column">
              <label class="label" for="memoid">Journal ID:</label>
