      ...
      <div id="carousel-slider" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
          <div class="item active">
            <img src="https://images.theconversation.com/files/85378/original/image-20150617-23232-nopbus.jpg?ixlib=rb-1.1.0&q=45&auto=format&w=926&fit=clip" class="img-responsive" alt="">
    ...
    <div class="container">
      <div class="row">
        <div class="text-center">
          <h3>Features</h3>
          <p>Upload photos, videos, audio, old documents<br>amet consectetur adipisicing elit</p>
        </div>
        <div class="col-md-3 wow fadeInRight" data-wow-offset="0" data-wow-delay="0.3s">
          <div class="text-center">
            <div class="hi-icon-wrap hi-icon-effect">
              <i class="fa fa-laptop"></i>
              <h2>Memories in One Place</h2>
              <p>Photos, Audio, Videos, Old Documents</p>
            </div>
          </div>
        </div>
        <div class="col-md-3 wow fadeInRight" data-wow-offset="0" data-wow-delay="0.3s">
          <div class="text-center">
            <div class="hi-icon-wrap hi-icon-effect">
              ...
              <p>Never miss any appointments</p>
            </div>
          </div>
        </div>
        <div class="col-md-3 wow fadeInLeft" data-wow-offset="0" data-wow-delay="0.3s">
          <div class="text-center">
            <div class="hi-icon-wrap hi-icon-effect">
              ...
              <h2>Easily Used</h2>
              <p>Clearly laid out and easily navigated</p>
            </div>
          </div>
        </div>
        <div class="col-md-3 wow fadeInLeft" data-wow-offset="0" data-wow-delay="0.3s">
          <div class="text-center">
            <div class="hi-icon-wrap hi-icon-effect">
              ...
              <h2>Family members in one place</h2>
              <p>Add family members into your account</p>
            </div>
          </div>
        </div>
      </div>
